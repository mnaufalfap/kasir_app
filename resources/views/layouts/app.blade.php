        ...
        <nav class="navbar navbar-expand-md navbar-dark primary-color">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                    <a class="nav-link font-weight-bolder" href="{{url('transcation')}}">Transaksi Penjualan                        
                        </a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="{{route('products.index')}}">List Produk</a>
                        </div>
                    </li>

                    <li class="nav-item">
                      <a class="nav-link" href="{{url('/transcation/history')}}">Histori Penjualan</a>
                    </li>
                    <li class="nav-item">
